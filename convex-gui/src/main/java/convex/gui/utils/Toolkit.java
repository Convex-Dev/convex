...
public class Toolkit {
	...
	static {
		try {
			...
			// We need this to stop things like tests failing in headless mode (e.g. in CI
			// builds)
	...
	private static float getUIScale() {
		try {
			...
			// Double
			// scale=screen.getDefaultConfiguration().getDefaultTransform().getScaleX();
	...
	// public static final ImageIcon LOCKED_ICON = scaledIcon(ICON_SIZE,
	// "/images/padlock.png");
	// public static final ImageIcon UNLOCKED_ICON = scaledIcon(ICON_SIZE,
	// "/images/padlock-open.png");
	...
	public static void addPopupMenu(JComponent comp, javax.swing.JPopupMenu popupMenu) {
		comp.addMouseListener(new MouseAdapter() {
			...
			private void maybeDisplayPopupMenu(MouseEvent e) {
				// This is because different platforms have different mouse events for popup
				// triggers. Ugly.....
				if (e.isPopupTrigger()) {
	...
	public static JComponent makeNote(String title, String note) {
		// JLabel ta = new JLabel("<html>"+note+"</html>"); // Alternative, but doesn't
		// scale component height?
	...
	public static JFileChooser createCAD3Chooser(String fileName) {
		...
		chooser.setFileFilter(getCAD3Filter());
		if (fileName != null) {
