 ...
 */
@Command(name = "convex",
		subcommands = { Account.class, Dlfs.class, Eval.class, Key.class, Local.class, Peer.class, Query.class, Repl.class, Status.class, Desktop.class,
