...
public class InitConfigTest  extends AInitConfig {
	...
	protected Address heroAddress;
	protected Address villainAddress;

	// public static Address firstPeerAddress;

	// Hero and Villain keys
	protected AKeyPair heroKeyPair;
	protected AKeyPair villainKeyPair;
	...
	private InitConfigTest(AKeyPair userKeyPairs[], AKeyPair peerKeyPairs[]) {
		...
		this.heroAddress = Init.BASE_FIRST_ADDRESS;
		this.villainAddress =  Address.create(Init.BASE_FIRST_ADDRESS.longValue() + 1);
		this.heroKeyPair = userKeyPairs[0];
		this.villainKeyPair = userKeyPairs[1];
	}
	...
	public static InitConfigTest create() {
		...
		// firstPeerAddress = Address.create(Init.BASE_FIRST_ADDRESS.longValue() + NUM_USERS);
	...
	public Address getHeroAddress() {
		return heroAddress;
	}
	public AKeyPair getHeroKeyPair() {
		return heroKeyPair;
	}

	public Address getVillainAddress() {
		return villainAddress;
	}
	public AKeyPair getVillainKeyPair() {
		return villainKeyPair;
	}

	/*
	public Address getFirstPeerAddress() {
		return firstPeerAddress;
	}
	*/
}
