...
public class StakingTest {
	...
	AccountKey FIRST_PEER_KEY=TestState.FIRST_PEER_KEY;
	...
	public void testStake() {
		...
		assertEquals(TestState.HERO_BALANCE, ctx3.getState().getPeer(FIRST_PEER_KEY).getDelegatedStake(Init.HERO));
	...
	public void testBadStake() {
		...
		assertStateError(ctx0.setStake(TestState.HERO_KP.getAccountKey(), 1000));
