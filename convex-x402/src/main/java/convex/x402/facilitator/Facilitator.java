...
public class Facilitator {
	private static final Logger log = LoggerFactory.getLogger(Facilitator.class);
	 ...
	 */
	public Facilitator(Convex convex, NetworkId networkId) {
	 ...
	 */
	public Facilitator(Convex convex, NetworkId networkId, Predicate<Hash> confirmedCheck) {
